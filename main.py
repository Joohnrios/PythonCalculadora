...
def entrar_valores(event):
    ...
    global todos_valores # Para

    todos_valores = todos_valores + str(event) #Variável vai ser atribuída ao "event".
...
def limpar_tela():
    global todos_valores #Qualquer alteração que fizer em "todos_valores" também será alterada aqui.
    todos_valores = ""
    valor_texto.set("")



app_lavel = Label(frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('Ivy 18'), bg=cor3, fg=cor4)
app_lavel.place(x=0, y=0)
